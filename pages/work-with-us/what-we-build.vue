<template>
  <div>
    ...
    <section class="hero">
      ...
      <h1>What We Build</h1>
      <p>Custom Software, Built by the Guild</p>
      <span class="launch-badge">Modern. Custom. Yours.</span>
    </section>
    ...
    <!-- Find the Right Package Section -->
    <section class="find-package-section">
      <div class="content">
        <div class="section-header">
    ...
    <section class="journey-section">
      <div class="content">
        ...
        <div class="pricing-table-wrapper">
          <table class="pricing-table journey-table">
            <thead>
              <tr>
                <th>Stage</th>
                <th>What Happens</th>
