  ...
  <div>
    ...
    <section class="hero">
      ...
      <svg class="wandering-path" viewBox="0 0 1200 150">
        <path class="path" d="M0,100 Q300,50 600,80 T1200,60" />
      </svg>
    </section>
          ...
          <a href="/principles/accessible" class="principle-card" style="animation-delay: 0.1s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                <h3>Accessible</h3>
                <p class="principle-tagline">Free Knowledge for All</p>
              </div>
            </div>
          ...
          <a href="/principles/integrity" class="principle-card" style="animation-delay: 0.2s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                ...
                <p class="principle-tagline">No Hidden Agendas</p>
              </div>
            </div>
            <p class="principle-description">
          ...
          <a href="/principles/individualized" class="principle-card" style="animation-delay: 0.3s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                ...
                <p class="principle-tagline">Your Path, Your Way</p>
              </div>
            </div>
            <p class="principle-description">
          ...
          <a href="/principles/engaging" class="principle-card" style="animation-delay: 0.4s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                ...
                <p class="principle-tagline">Learning Should Spark Joy</p>
              </div>
            </div>
            <p class="principle-description">
          ...
          <a href="/principles/relevant" class="principle-card" style="animation-delay: 0.6s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                ...
                <p class="principle-tagline">Real Skills for Real Jobs</p>
              </div>
            </div>
            <p class="principle-description">
          ...
          <a href="/principles/reinvestment" class="principle-card" style="animation-delay: 1.2s;">
            <div class="principle-header">
              ...
              <div class="principle-title">
                ...
                <p class="principle-tagline">Every Penny for Purpose</p>
              </div>
            </div>
            <p class="principle-description">
